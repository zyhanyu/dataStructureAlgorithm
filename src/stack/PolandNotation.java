...
public class PolandNotation {
	...
	public static void main(String[] args) {
		...
		System.out.printf("expressin=%d",calculate(suffixExpressionList));
		// 先定义一个逆波兰表达式
...
//		System.out.println(res);
	...
	public static List<String> parseSuffixExpressionList(List<String> ls){
		...
		// 应为比较麻烦，我们不用Stack<String>(); 直接使用List<String> s2
		// Stack<String> s2 = new ArrayList<String>();//储存中间结果Lists2
		...
		for(String item: ls){
			...
			if (item.matches("\\d+")) {
				...
				// 如果是右括号")",则依次弹出s1栈顶的算术符，并压入s2，直到遇到左括号为止，此时将这一对括号丢弃
